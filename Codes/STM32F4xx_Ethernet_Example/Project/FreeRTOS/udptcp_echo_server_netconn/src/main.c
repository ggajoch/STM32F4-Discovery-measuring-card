...
//			MineBuf = netbuf_new();
//			
//			//Buffer = netconn_recv(Connection);
//			//Address = netbuf_fromaddr(Buffer);
...
//					
//					netbuf_ref(MineBuf, tekst, strlen(tekst));
//					netconn_send(Connection,MineBuf);
//					prev = ain/17;
//					
//				}
//				LCD_Clear(Black);
...
xTaskCreate(ToggleLed4, "LED4", configMINIMAL_STACK_SIZE, NULL, LED_TASK_PRIO,
		NULL);
